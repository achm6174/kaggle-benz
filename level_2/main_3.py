...
def f(coord,args):
    ...
    return -r2_score(df_train.y.values, coord[0]*(df_1.y.values) + coord[1]*(df_2.y.values) + coord[2]*(df_4.y.values) )
...
tmp = (res.x[0]*(df_1.y.values)  + res.x[1]*(df_2.y.values) + res.x[2]*(df_4.y.values))
